...
- [ ] **SM-2.1** Design UI for speaker mapping during/after import
...
- [ ] **SM-2.2** Create speaker ID → contact mapping data structure
- [ ] **SM-2.3** Implement persistent storage for speaker ID mappings (for future auto-suggest)
- [ ] **SM-2.4** Implement global find/replace function for transcripts
- [ ] **SM-2.5** Update transcript to use contact links (format TBD based on RD-4)
- [ ] **SM-2.6** On future imports, auto-suggest known speaker ID mappings
- [ ] **SM-2.7** Test import with multiple speaker IDs
- [ ] **SM-2.8** Test that mappings persist and auto-suggest works

**Files likely involved:**
- `src/renderer/` - import wizard UI
- New: `src/main/services/speakerMappingService.js`
- Storage location for mappings
