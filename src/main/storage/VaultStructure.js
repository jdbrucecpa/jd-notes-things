...
// Vault path constants for people/company pages
const VAULT_PATHS = {
  people: 'People',
  companies: 'Companies',
};
...
`;
  ...
  contactPageExists(contactName) {
    ...
    return this.fileExists(`${this.getPeoplePath()}/${filename}.md`);
  }
  ...
  companyPageExists(companyName) {
    ...
    return this.fileExists(`${this.getCompaniesPath()}/${filename}.md`);
  }
